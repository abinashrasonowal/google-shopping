...
class GoogleShoppingImmersiveParser:
    ...
    @classmethod
    def _extract_sellers(cls, soup: BeautifulSoup) -> list[dict[str, str | None]]:
        sellers = []
    ...
    @classmethod
    def parse_product(cls, soup: BeautifulSoup, url: str, fetch_url: str) -> dict:
        rating_label = cls._extract_rating_label(soup)
        buying_options = cls._extract_sellers(soup)
